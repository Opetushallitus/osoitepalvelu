...
OsoiteKoostepalvelu.service('SavesService', ["$log", "DummySaves", "$filter", "FilterHelper", "SaveConverter",
    ...
    this.getSearch = function(id, success) {
        success(SaveConverter.fromDomain(
            {"id":5,"searchType":"CONTACT","createdAt":1386869725347,"addressFields":["ORGANISAATIO_NIMI","POSTIOSOITE","VIRANOMAISTIEDOTUS_EMAIL"],"targetGroups":[{"type":"OPPISOPIMUSTOIMPISTEET","options":[]},{"type":"MUUT_ORGANISAATIOT","options":["TUNNUKSENHALTIJAT"]},{"type":"TUTKINTOTOIMIKUNNAT","options":["PUHEENJOHTAJA","JASENET"]},{"type":"KOULUTA_KAYTTAJAT","options":["TUNNUKSENHALTIJAT"]},{"type":"AIPAL_KAYTTAJAT","options":["TUNNUKSENHALTIJAT"]}],"terms":[{"type":"tutkintotoimikuntas","values":[]},{"type":"tutkintotoimikuntaRoolis","values":["PUHEENJOHTAJA","JASENET"]},{"type":"koulutaRoolis","values":[]},{"type":"aipalRoolis","values":[]},{"type":"organisaationKielis","values":[]},{"type":"avis","values":[]},{"type":"maakuntas","values":[]},{"type":"kuntas","values":[]},{"type":"oppilaitostyyppis","values":[]},{"type":"omistajatyyppis","values":[]},{"type":"vuosiluokkas","values":[]},{"type":"koultuksenjarjestajas","values":[]}]}
        ));
    };
