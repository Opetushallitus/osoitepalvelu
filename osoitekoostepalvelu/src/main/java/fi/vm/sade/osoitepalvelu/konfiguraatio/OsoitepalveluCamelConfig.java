package fi.vm.sade.osoitepalvelu.konfiguraatio;
...
public class OsoitepalveluCamelConfig {
	...
	/**
	 * Alustaa Camel-kontekstin ja lisää kaikki tunnetut reitit tähän kontekstiin.
	 * Palvelussa täytyy olla ainakin yksi SpringRouteBuilder -luokasta
	 * periytetty luokka, jotta palvelin ohjelma suostuu käynnistymään.
	 */
	@Bean
	public CamelContext getCamelContext(RoutesBuilder[] builders,
	 ...
	 * @param context Camel konteksti.
	 * @return Viite Camel ProducerTemplate -luokkaan, jonka kautta voi välittää dataa
	 *         Camel-reitteihin. 
	 */
